...
import tech.thatgravyboat.skyblockapi.api.repo.SkyBlockRunesRepo
...
object RepoRunesAPI {
    ...
    fun getRuneAsItemOrNull(id: String, tier: Int? = null): ItemStack? = SkyBlockRunesRepo.getItemStack("$id:$tier")
    fun getRuneAsItem(id: String, tier: Int): ItemStack = SkyBlockRunesRepo.getItemStackOrDefault("$id:$tier")
